...
public class RolBeanDAO implements DAO<Object, Rol> {
    ...
    public int count() {
        javax.persistence.criteria.CriteriaQuery cq = this.em.getCriteriaBuilder().createQuery();
        javax.persistence.criteria.Root<Rol> rt = cq.from(Rol.class);
	...
	public List<Rol> findByNamedQuery(String queryName,
			int resultLimit) {
